...
var questions = [
	{
		"image": "res://questions/strings/L2Q1.png",
		"answers": ["Numbers", "Booleans", "Strings", "Floats"],
		"correct": "Strings"
	},
	{
		"image": "res://questions/strings/L2Q2.png",
		"answers": ['“Hello”', "'World'", "Hello", '"42'],
		"correct": "“Hello”"
	},
	{
		"image": "res://questions/strings/L2Q3.png",
		"answers": [
			'"Alice" + " Smith"',
			'"Alice".join("Smith")',
			'"Alice".add("Smith")',
	...
	{
		"image": "res://questions/strings/L2Q4.png",
		"answers": [
			"word.length()",
			"length(word)",
			"word.size",
